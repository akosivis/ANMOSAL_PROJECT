...
public class ChatClientTerminal{
    ...
    private String errorChecker(String exp_string, TcpPacket rp, byte[] toBeParsed) throws IOException{
        ...
        if(rp.getType() == TcpPacket.PacketType.DISCONNECT){
            ...
            /*yaan mo siya*/
            ConnectPacket suc_res = ConnectPacket.parseFrom(toBeParsed);
            System.out.println(suc_res.getPlayer().getName() + " just connected");
    ...
    public static void main(String args[]){
        ChatClientTerminal client = new ChatClientTerminal("Hana");
        try{
            //client.clickCreateLobby();
            client.clickConnectToLobby();
